...
CREATE TABLE `prescription_details` (
  ...
  KEY `id_med` (`id_med`),
  CONSTRAINT `prescription_details_ibfk_1` FOREIGN KEY (`id_prescription`) REFERENCES `prescription` (`id`),
  CONSTRAINT `prescription_details_ibfk_2` FOREIGN KEY (`id_med`) REFERENCES `med` (`id`)
